...
`cloud-itonami-4210` accepts contributions to the OSS blueprint,
...
the business blueprint, the Road-Rail Advisor/Governor actor and operator
contracts.
...
- Keep every proposal behind the Road-Rail Governor, and keep every
...
- Never extend this actor's op-allowlist, advisor or governor to permit
  heavy-equipment control or engineering-design/grade-plan-finalization
...
- Extending `roadrail.facts` coverage to a new jurisdiction requires a
