# Operator Quickstart — Construction of Roads and Railways

Shortest path from clone to a verified local dry-run for **ISIC 4210** (`cloud-itonami-isic-4210`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4210.git
cd cloud-itonami-isic-4210
```
...
- Blueprint governor key: `road-rail-governor`
- Likely source path: `roadrail.governor.cljc`
