(ns roadrail.registry-test
  (:require [clojure.test :refer [deftest is]]
            [roadrail.registry :as r]))
...
(def sample-site
  {:id "site-1" :name "Sakura Avenue Road Widening" :jurisdiction "JPN"})
...
(deftest safety-concern-notice-cites-legal-basis-inline
  (let [doc (r/render-safety-concern-notice sample-site "JPN-SCF-000000" "試掘溝で未表示のガス管を確認")]
    ...
    (is (re-find #"licensed civil engineer" doc) "honestly disclaims design/grade-plan-finalization authority")))
